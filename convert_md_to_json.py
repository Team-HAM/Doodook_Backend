...
def convert_md_to_json(file_path):
    ...
    # JSON 파일로 저장
    with open("tutorial_guides.json", "w", encoding="utf-8") as output_file:
        json.dump(guides, output_file, ensure_ascii=False, indent=4)

    print("튜토리얼 Markdown 파일이 JSON으로 변환되었습니다!")

# 실행
convert_md_to_json("tutorial_guides.md")
